...
RandomizableBlockActorContainerBase::RandomizableBlockActorContainerBase(BlockActorType type, const std::string& id, const BlockPos& position) : 
	BlockActor(type, position, id),
	mLootTable(""),
	mLootTableSeed(0)
{
}