...
public:
    ...
    virtual BlockActor* getBlockEntity(const BlockPos& pos) const;
...
public:
	...
	/// @sig {4C 8B DC 45 89 43 ? 49 89 53}
	MC void fireBlockChanged(const BlockPos& pos, uint32_t layer, const Block& block, const Block& oldBlock, int flags, BlockChangedEventTarget target, const ActorBlockSyncMessage* syncMsg, Actor* cause);
};
#pragma pack(pop)
